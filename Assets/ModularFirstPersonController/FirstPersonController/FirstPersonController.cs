...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        orbManager = orbManagerObj.GetComponent<OrbManager>();
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        #region Throw
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("Throw Setup", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        EditorGUILayout.Space();

        fpc.throwingPoint = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Throwing Point", "The point where orbs are thrown from"), fpc.throwingPoint, typeof(GameObject), true);
        fpc.orbManagerObj = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Orb Manager Object", "The object to which the orb manager script is on"), fpc.orbManagerObj, typeof(GameObject), true);
        fpc.throwingStrength = EditorGUILayout.FloatField(new GUIContent("Throwing Strength", "How far the orb is thrown"), fpc.throwingStrength);
        #endregion
